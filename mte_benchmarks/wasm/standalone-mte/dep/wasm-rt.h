...
#ifndef WASM_RT_USE_SEGUE_LOAD
#define WASM_RT_USE_SEGUE_LOAD 0
#endif

#ifndef WASM_RT_USE_SEGUE_STORE
#define WASM_RT_USE_SEGUE_STORE 0
#endif

#if (WASM_RT_USE_SEGUE + WASM_RT_USE_SEGUE_LOAD + WASM_RT_USE_SEGUE_STORE) > 1
...
// Specify defaults for memory checks if unspecified
    ...
    !defined(WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP) &&     \
    !defined(WASM_RT_MEMCHECK_BOUNDS_CHECK_ASM) && \
    !defined(WASM_RT_MEMCHECK_SHADOW_PAGE) &&      \
    !defined(WASM_RT_MEMCHECK_PRESHADOW_PAGE) &&      \
    !defined(WASM_RT_MEMCHECK_SHADOW_BYTES) &&     \
    !defined(WASM_RT_MEMCHECK_SHADOW_BYTES_TAG) &&     \
    !defined(WASM_RT_MEMCHECK_PRESHADOW_BYTES) &&  \
    !defined(WASM_RT_MEMCHECK_DEBUG_WATCH) && \
    !defined(WASM_RT_MEMCHECK_MPX) && \
    !defined(WASM_RT_MEMCHECK_DUMMY) && \
    !defined(WASM_RT_MEMCHECK_DUMMY2) && \
    !defined(WASM_RT_MEMCHECK_DUMMY3) && \
    !defined(WASM_RT_MEMCHECK_MASK_PDEP) && \
    !defined(WASM_RT_MEMCHECK_MASK_PDEP48) && \
    !defined(WASM_RT_MEMCHECK_MASK_PEXT)
...
#endif
#ifndef WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP
#define WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP 0
#endif
#ifndef WASM_RT_MEMCHECK_BOUNDS_CHECK_ASM
#define WASM_RT_MEMCHECK_BOUNDS_CHECK_ASM 0
#endif
#ifndef WASM_RT_MEMCHECK_SHADOW_PAGE
#define WASM_RT_MEMCHECK_SHADOW_PAGE 0
#endif
#ifndef WASM_RT_MEMCHECK_PRESHADOW_PAGE
#define WASM_RT_MEMCHECK_PRESHADOW_PAGE 0
#endif
#ifndef WASM_RT_MEMCHECK_SHADOW_BYTES
#define WASM_RT_MEMCHECK_SHADOW_BYTES 0
#endif
#ifndef WASM_RT_MEMCHECK_SHADOW_BYTES_TAG
#define WASM_RT_MEMCHECK_SHADOW_BYTES_TAG 0
#endif
...
#endif
#ifndef WASM_RT_MEMCHECK_MPX
#define WASM_RT_MEMCHECK_MPX 0
#endif
#ifndef WASM_RT_MEMCHECK_DUMMY
#define WASM_RT_MEMCHECK_DUMMY 0
#endif
#ifndef WASM_RT_MEMCHECK_DUMMY2
#define WASM_RT_MEMCHECK_DUMMY2 0
#endif
#ifndef WASM_RT_MEMCHECK_DUMMY3
#define WASM_RT_MEMCHECK_DUMMY3 0
#endif
#ifndef WASM_RT_MEMCHECK_MASK_PDEP
#define WASM_RT_MEMCHECK_MASK_PDEP 0
#endif
#ifndef WASM_RT_MEMCHECK_MASK_PDEP48
#define WASM_RT_MEMCHECK_MASK_PDEP48 0
#endif
#ifndef WASM_RT_MEMCHECK_MASK_PEXT
#define WASM_RT_MEMCHECK_MASK_PEXT 0
#endif

#ifndef WASM_RT_SPECTREMASK
#define WASM_RT_SPECTREMASK 0
#endif
...
#if WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP
#if !defined(WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP_SCHEME) || \
    WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP_SCHEME < 1 ||       \
    WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP_SCHEME > 2
#error "Expected value for WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP_SCHEME between 1 and 2"
#endif
#endif
...
#if !defined(WASM_RT_MEMCHECK_SHADOW_BYTES_SCHEME) || \
    WASM_RT_MEMCHECK_SHADOW_BYTES_SCHEME < 1 ||       \
    WASM_RT_MEMCHECK_SHADOW_BYTES_SCHEME > 8
#error "Expected value for WASM_RT_MEMCHECK_SHADOW_BYTES_SCHEME between 1 and 8"
#endif
#endif

#if WASM_RT_MEMCHECK_SHADOW_BYTES_TAG
#if !defined(WASM_RT_MEMCHECK_SHADOW_BYTES_TAG_SCHEME) || \
    WASM_RT_MEMCHECK_SHADOW_BYTES_TAG_SCHEME < 1 ||       \
    WASM_RT_MEMCHECK_SHADOW_BYTES_TAG_SCHEME > 2
#error "Expected value for WASM_RT_MEMCHECK_SHADOW_BYTES_TAG_SCHEME between 1 and 2"
#endif
#endif

#if (WASM_RT_MEMCHECK_GUARD_PAGES + WASM_RT_MEMCHECK_BOUNDS_CHECK + WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP +     \
     WASM_RT_MEMCHECK_BOUNDS_CHECK_ASM + WASM_RT_MEMCHECK_SHADOW_PAGE + WASM_RT_MEMCHECK_PRESHADOW_PAGE + \
     WASM_RT_MEMCHECK_SHADOW_BYTES + WASM_RT_MEMCHECK_SHADOW_BYTES_TAG + WASM_RT_MEMCHECK_PRESHADOW_BYTES + \
     WASM_RT_MEMCHECK_DEBUG_WATCH + WASM_RT_MEMCHECK_MPX + WASM_RT_MEMCHECK_DUMMY + WASM_RT_MEMCHECK_DUMMY2  + WASM_RT_MEMCHECK_DUMMY3 + \
     WASM_RT_MEMCHECK_MASK_PDEP + WASM_RT_MEMCHECK_MASK_PDEP48 + WASM_RT_MEMCHECK_MASK_PEXT) > 1
#error "Cannot use multiple memcheck schemes"
#elif (WASM_RT_MEMCHECK_GUARD_PAGES + WASM_RT_MEMCHECK_BOUNDS_CHECK + WASM_RT_MEMCHECK_BOUNDS_CHECK_TRAP +     \
       WASM_RT_MEMCHECK_BOUNDS_CHECK_ASM + WASM_RT_MEMCHECK_SHADOW_PAGE + WASM_RT_MEMCHECK_PRESHADOW_PAGE + \
       WASM_RT_MEMCHECK_SHADOW_BYTES + WASM_RT_MEMCHECK_SHADOW_BYTES_TAG + WASM_RT_MEMCHECK_PRESHADOW_BYTES + \
       WASM_RT_MEMCHECK_DEBUG_WATCH + WASM_RT_MEMCHECK_MPX + WASM_RT_MEMCHECK_DUMMY + WASM_RT_MEMCHECK_DUMMY2  + WASM_RT_MEMCHECK_DUMMY3 + \
       WASM_RT_MEMCHECK_MASK_PDEP + WASM_RT_MEMCHECK_MASK_PDEP48 + WASM_RT_MEMCHECK_MASK_PEXT) == 0
