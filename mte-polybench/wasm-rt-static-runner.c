...
int main(int argc, char** argv) {
  ...
  w2c_0x24sightglass0x2Ewasm inst = { 0 };
  ...
  wasm2c_0x24sightglass0x2Ewasm_instantiate(&inst, &wasi_env);

  /* Call `inst`, using the mangled name. */
  w2c_0x24sightglass0x2Ewasm_0x5Fstart(&inst);

  /* Free the inst module. */
  wasm2c_0x24sightglass0x2Ewasm_free(&inst);
