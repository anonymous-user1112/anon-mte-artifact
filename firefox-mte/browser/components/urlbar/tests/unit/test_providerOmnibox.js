  ...
  await check_results({
    ...
    matches: [
      makeOmniboxResult(context, {
        ...
        keyword,
        description: extensionName,
        content: `XXXXXXXXX unmatched`,
      }),
      makeOmniboxResult(context, {
        keyword,
        content: `XXXXXXXXX foo`,
        description: "first suggestion",
      }),
      makeOmniboxResult(context, {
        keyword,
        content: `XXXXXXXXX bar`,
        description: "second suggestion",
      }),
      makeOmniboxResult(context, {
        keyword,
        content: `XXXXXXXXX baz`,
...
add_task(async function test_extension_results_should_come_first() {
  ...
  await PlacesTestUtils.addVisits([{ uri, title: `XXXXXXXXX -` }]);
...
add_task(async function test_setting_the_default_suggestion() {
  ...
  let query = `XXXXXXXXX search query`;
  let context = createContext(query, { isPrivate: false });
  await check_results({
    context,
    matches: [
