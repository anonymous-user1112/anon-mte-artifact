...
@register_test()
class expat_perf_test(PageloaderTest):
    """
    Test the time taken to render jpeg images of increasing height
    """
    tpmanifest = '${talos}/tests/expat_perf_test/tests.manifest'
    tpcycles = 1
    tploadnocache = True
    tppagecycles = 110
    tpmozafterpaint = True
    ...
    filters = filter.ignore_first.prepare(10) + filter.median.prepare()
    unit = 'ms'
    timeout = 7200000

@register_test()
class expat_perf_test_mini(PageloaderTest):
    """
    Test the time taken to render jpeg images of increasing height
    """
    tpmanifest = '${talos}/tests/expat_perf_test/tests.manifest'
