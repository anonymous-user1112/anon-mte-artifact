        ...
        switch (typetag) {
            case SEC_OID_PKCS7_SIGNED_DATA: {
                ...
                if (decodeOptions->content.data != NULL &&
                    ...
                    digesXXXXXXXXs = NSS_CMSSignedData_GetDigestAlgs(sigd);
                    if (DigestFile(poolp, &digests, &sitem, digesXXXXXXXXs) !=
                        SECSuccess) {
                    ...
                    if (NSS_CMSSignedData_SetDigests(sigd, digesXXXXXXXXs, digests) !=
                        SECSuccess) {
                        SECU_PrintError(progName,
