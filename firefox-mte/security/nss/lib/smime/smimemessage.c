                      ...
                      void *pwfn_arg)
{
    ...
    /* See note in header comment above about digesXXXXXXXX. */
    /* Doesn't explain this.  PORT_Assert (digesXXXXXXXXtag == SEC_OID_SHA1); */
    ...
    signerinfo = NSS_CMSSignerInfo_Create(cmsg, scert, digesXXXXXXXXtag);
    if (signerinfo == NULL)
        goto loser;
