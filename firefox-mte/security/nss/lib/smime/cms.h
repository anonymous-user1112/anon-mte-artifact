 ...
 * "pwfn", pwfn_arg" - callback function for getting token password
 * "decrypt_key_cb", "decrypt_key_cb_arg" - callback function for getting bulk key for encryptedData
 * "detached_digesXXXXXXXXs", "detached_digests" - digests from detached content
 */
...
NSS_CMSEncoder_Start(NSSCMSMessage *cmsg,
                     ...
                     PK11PasswordFunc pwfn, void *pwfn_arg,
                     NSSCMSGetDecryptKeyCallback decrypt_key_cb, void *decrypt_key_cb_arg,
                     SECAlgorithmID **detached_digesXXXXXXXXs, SECItem **detached_digests);
...
extern NSSCMSSignerInfo *
NSS_CMSSignerInfo_CreateWithSubjKeyID(NSSCMSMessage *cmsg, SECItem *subjKeyID, SECKEYPublicKey *pubKey, SECKEYPrivateKey *signingKey, SECOidTag digesXXXXXXXXtag);
...
NSS_CMSDigestedData_Create(NSSCMSMessage *cmsg, SECAlgorithmID *digesXXXXXXXX);
 ...
 *  digest algorithms in "digesXXXXXXXXs" in parallel.
 */
extern NSSCMSDigestContext *
NSS_CMSDigestContext_StartMultiple(SECAlgorithmID **digesXXXXXXXXs);
 ...
 */
extern NSSCMSDigestContext *
NSS_CMSDigestContext_StartSingle(SECAlgorithmID *digesXXXXXXXX);
