                                ...
                                PK11SymKey *orig_bulkkey)
{
    ...
    for (i = 0; recipientinfos && (ri = recipientinfos[i]) != NULL; i++) {
        ...
        SECOidTag cerXXXXXXXXtag, encalgtag;
        SECStatus rv;
        int data_len;
        SECItem *params = NULL;
        ...
        cerXXXXXXXXtag = SECOID_GetAlgorithmTag(&(cert->subjectPublicKeyInfo.algorithm));

        switch (cerXXXXXXXXtag) {
            case SEC_OID_PKCS1_RSA_ENCRYPTION:
                encalgtag = cerXXXXXXXXtag;
                ...
                rv = PK11_PubWrapSymKey(PK11_AlgtagToMechanism(cerXXXXXXXXtag), publickey,
                                        bulkkey, &ri->encKey);
                                 ...
                                 PK11SymKey *bulkkey)
{
    ...
    PRBool encrypt;
    SECItem **digests;
    SECAlgorithmID *digesXXXXXXXX, **digesXXXXXXXXs;
    ...
    switch (kind) {
        ...
        case SEC_OID_PKCS7_DATA:
            break;
        case SEC_OID_PKCS7_DIGESTED_DATA:
            digesXXXXXXXX = &(cinfo->content.digestedData->digestAlg);
            break;
        case SEC_OID_PKCS7_SIGNED_DATA:
            digests = cinfo->content.signedData->digests;
            digesXXXXXXXXs = cinfo->content.signedData->digestAlgorithms;
            break;
        case SEC_OID_PKCS7_ENCRYPTED_DATA:
        case SEC_OID_PKCS7_ENVELOPED_DATA:
            encrypt = PR_TRUE;
        ...
        case SEC_OID_PKCS7_SIGNED_ENVELOPED_DATA:
            ...
            digesXXXXXXXXs = cinfo->content.signedAndEnvelopedData->digestAlgorithms;
            encrypt = PR_TRUE;
            break;
    }
    ...
    if (digesXXXXXXXXs != NULL) {
        if (digests != NULL) {
             ...
             */
            PORT_Assert(digesXXXXXXXXs[0] != NULL && digesXXXXXXXXs[1] == NULL);
            digesXXXXXXXX = digesXXXXXXXXs[0];
        }
    }

    if (digesXXXXXXXX != NULL) {
        SECOidTag oidTag = SECOID_FindOIDTag(&(digesXXXXXXXX->algorithm));
                                ...
                                SECKEYGetPasswordKey pwfn, void *pwfnarg)
{
    ...
    switch (kind) {
        ...
        case SEC_OID_PKCS7_SIGNED_DATA: {
            ...
            digesXXXXXXXXs = sdp->digestAlgorithms;
            digests = sdp->digests;
        ...
        case SEC_OID_PKCS7_SIGNED_ENVELOPED_DATA: {
            ...
            digesXXXXXXXXs = saedp->digestAlgorithms;
    ...
    if (signerinfos != NULL) {
        ...
        PORT_Assert(digesXXXXXXXXs != NULL && digests != NULL);
        ...
        for (si = 0; signerinfos[si] != NULL; si++) {
            ...
            /* find right digest */
            digesXXXXXXXXtag = SECOID_GetAlgorithmTag(&(signerinfo->digestAlg));
            for (di = 0; digesXXXXXXXXs[di] != NULL; di++) {
                /* XXX Should I be comparing more than the tag? */
                if (digesXXXXXXXXtag == SECOID_GetAlgorithmTag(digesXXXXXXXXs[di]))
                    break;
            }
            if (digesXXXXXXXXs[di] == NULL) {
            ...
            if (signerinfo->authAttr != NULL) {
                ...
                rv = SGN_Digest(privkey, digesXXXXXXXXtag, &signature,
                                digests[di]);
            }
