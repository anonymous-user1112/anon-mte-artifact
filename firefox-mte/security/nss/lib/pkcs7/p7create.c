                     ...
                     SECItem *digestdata)
{
    ...
    SECAlgorithmID *digesXXXXXXXX, **digesXXXXXXXXs, ***digesXXXXXXXXsp;
    ...
    switch (kind) {
        case SEC_OID_PKCS7_SIGNED_DATA: {
            ...
            digesXXXXXXXXsp = &(sdp->digestAlgorithms);
        ...
        case SEC_OID_PKCS7_SIGNED_ENVELOPED_DATA: {
            ...
            digesXXXXXXXXsp = &(saedp->digestAlgorithms);
     ...
     */
    PORT_Assert(*signerinfosp == NULL && *digesXXXXXXXXsp == NULL && *digestsp == NULL);
    if (*signerinfosp != NULL || *digesXXXXXXXXsp != NULL || *digestsp != NULL)
        return SECFailure;
    ...
    digesXXXXXXXX = PORT_ArenaZAlloc(cinfo->poolp, sizeof(SECAlgorithmID));
    digesXXXXXXXXs = PORT_ArenaAlloc(cinfo->poolp, 2 * sizeof(SECAlgorithmID *));
    if (digesXXXXXXXX == NULL || digesXXXXXXXXs == NULL) {
        PORT_ArenaRelease(cinfo->poolp, mark);
        return SECFailure;
    }
    rv = SECOID_SetAlgorithmID(cinfo->poolp, digesXXXXXXXX, digesXXXXXXXXtag, NULL);
    if (rv != SECSuccess) {
        PORT_ArenaRelease(cinfo->poolp, mark);
        return SECFailure;
    }
    digesXXXXXXXXs[0] = digesXXXXXXXX;
    digesXXXXXXXXs[1] = NULL;
    ...
    *digesXXXXXXXXsp = digesXXXXXXXXs;
    *digestsp = digests;
 ...
 *
 * "digesXXXXXXXX" names the digest algorithm (e.g. SEC_OID_SHA1).
 *
