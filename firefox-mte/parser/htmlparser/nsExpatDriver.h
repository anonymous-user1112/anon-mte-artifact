...
class nsExpatDriver : public nsIDTD {
 ...
 public:
  ...
  int HandleExternalEntityRef(rlbox_sandbox_expat& aSandbox, const char16_t* aOpenEntityNames,
...
class RLBoxExpatSandboxData : public mozilla::RLBoxSandboxDataBase {
 ...
 public:
  ...
  // E{Start,End}Element callbacks and associate the driver with the
  // sandbox.
